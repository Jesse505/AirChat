...
public interface InviteDialogListener {
	...
	/** When an audio switch is received  add by liuyang */
	public void onDlgSwitch(InviteDialog dialog, Message msg);
	
	/** When a success response is received for a Switch request */
	public void onDlgSwitchSuccessResponse(InviteDialog dialog, int code,
			String reason, Message msg);

	/** When a failure response is received for a Switch  request */
