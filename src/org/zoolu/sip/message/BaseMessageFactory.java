...
public abstract class BaseMessageFactory {
	...
	public static Message createRequest(String method, SipURL request_uri,
			...
			String branch, String body, String qvalue, String icsi,String calltype) {			// modified by mandrajg
		...
		if(calltype!=null)
			req.setCallTypeHeader(new CallTypeHeader(calltype));
	...
	public static Message createRequest(SipProvider sip_provider,
			...
			String local_tag, String remote_tag, String branch, String body, String icsi,String calltype) {	// modified by mandrajg
		...
		return createRequest(method, request_uri, to, from, contact, proto,
				...
				remote_tag, branch, body, null, icsi,calltype);							// modified by mandrajg
	}
	...
	public static Message createRequest(SipProvider sip_provider,
		...
		return createRequest(sip_provider, method, request_uri, to, from,
				contact, call_id, cseq, local_tag, null, null, body, null,null);		// modified by mandrajg
	}
	...
	public static Message createRequest(Dialog dialog, String method,
		...
		Message req = createRequest(method, request_uri, to, from, contact,
				...
				remote_tag, null, body, null, null,null);						// modified by mandrajg
	...
	public static Message createInviteRequest(SipProvider sip_provider,
			...
			NameAddress contact, String body, String icsi,String calltype) {			// modified by mandrajg
		String call_id = sip_provider.pickCallId();
		int cseq = SipProvider.pickInitialCSeq();
		String local_tag = SipProvider.pickTag();
		// String branch=SipStack.pickBranch();
		...
		return createRequest(sip_provider, SipMethods.INVITE, request_uri, to,
				from, contact, call_id, cseq, local_tag, null, null, body, icsi,calltype);	// modified by mandrajg
	}
	...
	public static Message createNon2xxAckRequest(SipProvider sip_provider,
		...
		Message ack = createRequest(SipMethods.ACK, request_uri, to
				...
				via_addr, host_port, rport, method.getCallIdHeader()
						...
						.getParameter("tag"), branch, null, null, null,null);	// modified by mandrajg
	...
	/** Creates a audio swithc request. */
	public static Message createAduidoSwithcRequest(Dialog dialog) {
		Message msg = createRequest(dialog, SipMethods.SWITCH, null);
		msg.removeExpiresHeader();
		msg.removeContacts();
		return msg;
	}
	...
	public static Message createRegisterRequest(SipProvider sip_provider,
		...
		Message req = createRequest(SipMethods.REGISTER, registrar, to, from,
				...
				local_tag, null, null, null, qvalue, icsi,null);						// modified by mandrajg
	...
	public static Message createResponse(Message req, int code, String reason,
		...
		// modify by liuyang for video call start
		CallTypeHeader h = req.getCallTypeHeader();
		if(h!=null)resp.setCallTypeHeader(req.getCallTypeHeader());
		//modify by liuyang for video call end
		if (contact != null)
