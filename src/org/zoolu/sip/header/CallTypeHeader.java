...
public class CallTypeHeader extends Header {
	/** Creates a CallTypeHeader with value <i>hvalue</i> */
	public CallTypeHeader(String hvalue) {
		super(SipHeaders.CallType, hvalue);
	}

	/** Creates a new CallTypeHeader equal to CallTypeHeader <i>hd</i> */
	public CallTypeHeader(Header hd) {
		super(hd);
	}

	/** Gets Type of CallTypeHeader */
