...
class CodecBase implements Preference.OnPreferenceChangeListener {
	...
	private boolean wlanOnly = false/*,wlanOr3GOnly = false*/;//delete by lss for deleting wlanor3g
	...
	public boolean isValid() {
		...
		if (/*wlanOr3GOnly() &&*/ nt < TelephonyManager.NETWORK_TYPE_UMTS)//modify by lss for deleting wlanor3g
			return false;
	...
	/*delete by lss for deleting wlanor3g
