...
import org.sipdroid.sipua.adapter.MembersDelAdapter.ViewHolder;
...
public class MembersAddAdapter extends BaseAdapter {

    private LayoutInflater layoutInflater;
    private List<Users> onlineMembers;
    private List<Users> onlineContacts;
    public Map<Integer, Boolean> map;
    
    public MembersAddAdapter(Context context, List<Users> onlineMembers, List<Users> onlineContacts){
	...
	@Override
	public int getCount() {
		return onlineContacts == null ? 0 : onlineContacts.size();
	}

	@Override
	public Object getItem(int position) {
		return onlineContacts == null ? null : onlineContacts.get(position);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Users User = onlineContacts.get(position);
        setData(viewHolder, User);
        if (onlineMembers.contains(User)) {
