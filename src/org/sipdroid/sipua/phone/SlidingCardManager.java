...
public class SlidingCardManager implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    /* package */ public void init(Phone phone,
        ...
        //delete by lss---mCallCard.setSlidingCardManager(this);
    }
    ...
    public /* package */ void updateCardPreferredPosition() {
        ...
        */
        ...
        if (Receiver.ccCall != null && Receiver.ccCall.getState() != Call.State.DISCONNECTED) {
            ...
            // not.
          //delete by lss--  final boolean hasRingingCall = Receiver.ccCall.getState() == Call.State.INCOMING;
          //delete by lss--  mCardAtTop = !hasRingingCall;
        	mCardAtTop =true;
       ...
       //delete by lss--- mCallCard.update(mCardPreferredX, mCardPreferredY, -1, -1);
    ...
    public /* package */ void updateCardSlideHints() {
       ...
       // final boolean hasRingingCall = Receiver.ccCall != null && Receiver.ccCall.getState() == Call.State.INCOMING;
        ...
        int slideUpHint = 0;
        int slideDownHint = 0;
       /*delete by lss-- if (hasRingingCall) {
    ...
    private void setSlideHints(int upHintResId, int downHintResId) {
        ...
        //modify by lss--mSlideUp.setVisibility((upHintResId != 0) ? View.VISIBLE : View.GONE);
        mSlideUp.setVisibility(View.VISIBLE);
       //delete by lss-- if (upHintResId != 0) mSlideUpHint.setText(upHintResId);

        /*mSlideDown.setVisibility((downHintResId != 0) ? View.VISIBLE : View.GONE);*/
       /*//modify by lss mSlideDown.setVisibility(View.GONE);
    ...
    /* package */ void updateWhileSliding(int y) {
       ...
       //delete by lss --- mCallCard.update(mCardPreferredX, newCardTop, -1, -1);
    }
    ...
    /* package */ void stopSliding(int y) {
       ...
       //delete by lss-- if (!mCardAtTop) totalSlideAmount = -totalSlideAmount;
