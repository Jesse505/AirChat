...
public class DateUtils {
    ...
    private static int AVAILABLE_TIME = 300000;
    /**
     * 获取yyyyMMdd格式日期
     * 
     * @param time
    ...
    public static String getDisplayTime(){
    	String displayTime;
    	if ((System.currentTimeMillis() - lastTime) > AVAILABLE_TIME) {
    		displayTime = DateUtils.getNowtime();
    		lastTime = System.currentTimeMillis(); 
    		MyLog.d("lss","Date displayTime="+displayTime);
		} else { 
			displayTime = "";			
		}
    	return displayTime;
    }
    public static String getMessageListTime(){
    	String displayTime;
    	displayTime = DateUtils.getNowtime();		
    	return displayTime;
    }
