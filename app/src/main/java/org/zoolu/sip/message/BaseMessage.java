...
//		String sent_by = top_via.getSentBy();
	...
	/** Whether Message is a SWITCH */
	public boolean isSwitch() {
		return isRequest(SipMethods.SWITCH);
	}
	...
	/** Sets CalltypeHeader of Message */
	public void setCallTypeHeader(CallTypeHeader cth) {
		setHeader(cth);
	}
	...
	/** Gets CallTypeHeader of Message */
	public CallTypeHeader getCallTypeHeader() {
		Header h = getHeader(SipHeaders.CallType);
		if (h == null)
			return null;
		else
